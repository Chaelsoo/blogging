# Part 1 — Understanding What's Actually Catching You
...
![AMSI Bypass Techniques and Effectiveness](techniques.png)
...
![Binary Search Workflow - Gocheck](gocheck.png)
...
This is the layer that catches you after your code is already running. It doesn't care about signatures, doesn't care about AMSI — it watches what your code *does* at runtime and flags patterns that look malicious regardless of what the binary looked like on disk.
...
![Userland Hook Mechanism and Behavioral Detection](behavior.png)
...
![Windows Process Initialization Timeline](defender_intro.jpeg)
...
Next blog, we'll get into how to actually approach each of the two problems above — the techniques, the reasoning, and where thinking outside the box starts to matter a lot.
